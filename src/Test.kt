...
fun main() {
    ...
    var arr: ArrayList<Question> = arrayListOf(
        Question("С абстрактными неопределеными процессами, выражаемыми герундиями: running, reading", "no articles"),
        Question("С абстрактными определеными процессами, выражаемыми герундиями: running, reading", "the"),
